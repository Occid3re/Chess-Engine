...
public final class BestMoveFixtures {
    ...
    private static final List<BestMoveTestCase> CASES = List.of(
            ...
            new BestMoveTestCase(
                    "8/8/8/2p2Pk1/8/P2R2K1/3r4/8 b - - 2 48",
                    List.of("Rxd3"),
                    8
            ),
            new BestMoveTestCase(
                    "8/6k1/1pp5/2p3p1/2B1p1b1/P7/3K4/5R2 w - - 0 36",
                    List.of("Rf7", "Ke3", "a4"),
                    7
            ),
            new BestMoveTestCase(
                    "8/1p3ppp/4k3/8/1p2r1P1/5K2/2R4P/8 b - - 3 37",
                    List.of("b3", "Rd4", "Kd5", "f5"),
                    4
            ),
            new BestMoveTestCase(
                    "r3k2r/p4ppp/P1p1pq2/1pnn4/1b1PP2P/2N2N2/1PK2PP1/R1BQ3R b kq - 2 15",
                    List.of("Nxc3")

            ),
            new BestMoveTestCase(
                    "8/3k4/6N1/8/p1Pp4/P6K/1P6/8 w - - 0 48",
                    List.of("Nh4", "Nf4", "Ne5", "Kg4", "Kg3"),
                    8
            ...
            new BestMoveTestCase(
                    "8/8/8/5b2/8/4n3/5k1K/8 b - - 97 103",
                    List.of("Nf1")
