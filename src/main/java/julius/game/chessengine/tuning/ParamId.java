...
public enum ParamId {
    ...
    PAWN_STRUCTURE_SUPPORTED_PASSED_PAWN_BONUS("pawnStructure.supportedPassedPawnBonus", 6),
    ...
    ACTIVITY_KNIGHT_OUTPOST_MIDGAME("activity.knightOutpostMidgame", 5),
    ACTIVITY_KNIGHT_OUTPOST_ENDGAME("activity.knightOutpostEndgame", 3),
    ACTIVITY_BISHOP_OUTPOST_MIDGAME("activity.bishopOutpostMidgame", 3),
    ACTIVITY_BISHOP_OUTPOST_ENDGAME("activity.bishopOutpostEndgame", 2),
    ...
    KING_SAFETY_PAWN_STORM_MIDGAME_PENALTY("kingSafety.pawnStormMidgamePenalty", -10),
    KING_SAFETY_PAWN_STORM_ENDGAME_PENALTY("kingSafety.pawnStormEndgamePenalty", -6),
    ...
    SEARCH_FP_MARGIN_DEPTH3("search.fpMarginDepth3", 0, 0.0, 12000.0),
    SEARCH_SNMP_MARGIN_DEPTH1("search.snmpMarginDepth1", 120, 0.0, 4000.0),
    SEARCH_SNMP_MARGIN_DEPTH2("search.snmpMarginDepth2", 180, 0.0, 4000.0),
    SEARCH_SNMP_MARGIN_DEPTH3("search.snmpMarginDepth3", 240, 0.0, 4000.0),
    SEARCH_RAZOR_MARGIN_DEPTH1("search.razorMarginDepth1", 200, 0.0, 4000.0),
    SEARCH_RAZOR_MARGIN_DEPTH2("search.razorMarginDepth2", 300, 0.0, 4000.0),
    SEARCH_PROB_CUT_ENABLE_DEPTH("search.probCutEnableDepth", 4, 0.0, 32.0),
    SEARCH_PROB_CUT_MARGIN("search.probCutMargin", 150, 0.0, 2000.0),
    SEARCH_PROB_CUT_SEE_MIN("search.probCutSeeMin", 0, -4000.0, 4000.0),
    ...
    SEARCH_LQP_MAX_DEPTH("search.lqpMaxDepth", 3, 0.0, 8.0),
    SEARCH_LQP_MOVE_INDEX_THRESHOLD("search.lqpMoveIndexThreshold", 8, 0.0, 64.0),
    SEARCH_LQP_HISTORY_THRESHOLD("search.lqpHistoryThreshold", 150, 0.0, 65536.0),
    SEARCH_LQP_BUTTERFLY_THRESHOLD("search.lqpButterflyThreshold", 3, 0.0, 65536.0),
