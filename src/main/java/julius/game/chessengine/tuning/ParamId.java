...
public enum ParamId {
    ...
    ACTIVITY_OUTPOST_KNIGHT_MIDGAME("activity.outpostKnightMidgame", 18, 0.0, 200.0),
    ACTIVITY_OUTPOST_KNIGHT_ENDGAME("activity.outpostKnightEndgame", 10, 0.0, 200.0),
    ACTIVITY_OUTPOST_BISHOP_MIDGAME("activity.outpostBishopMidgame", 12, 0.0, 200.0),
    ACTIVITY_OUTPOST_BISHOP_ENDGAME("activity.outpostBishopEndgame", 6, 0.0, 200.0),
    ...
    KING_SAFETY_STORM_PAWN_PENALTY("kingSafety.stormPawnPenalty", -8, -100.0, 0.0),
    ...
    SEARCH_SNMP_MARGIN_DEPTH1("search.snmpMarginDepth1", 120, 0.0, 8000.0),
    SEARCH_SNMP_MARGIN_DEPTH2("search.snmpMarginDepth2", 180, 0.0, 8000.0),
    SEARCH_SNMP_MARGIN_DEPTH3("search.snmpMarginDepth3", 240, 0.0, 8000.0),
    SEARCH_RAZOR_MARGIN_DEPTH1("search.razorMarginDepth1", 200, 0.0, 8000.0),
    SEARCH_RAZOR_MARGIN_DEPTH2("search.razorMarginDepth2", 300, 0.0, 8000.0),
    SEARCH_PROBCUT_ENABLE_DEPTH("search.probCutEnableDepth", 4, 0.0, 32.0),
    SEARCH_PROBCUT_MARGIN("search.probCutMargin", 150, 0.0, 8000.0),
    SEARCH_PROBCUT_SEE_MIN("search.probCutSeeMin", 0, -8000.0, 8000.0),
    SEARCH_EFP_MARGIN_DEPTH1("search.efpMarginDepth1", 120, 0.0, 8000.0),
    SEARCH_EFP_MARGIN_DEPTH2("search.efpMarginDepth2", 220, 0.0, 8000.0),
    SEARCH_EFP_MARGIN_DEPTH3("search.efpMarginDepth3", 320, 0.0, 8000.0),
    SEARCH_LQP_HISTORY_CUTOFF("search.lqpHistoryCutoff", 200, 0.0, 65536.0),
    SEARCH_LQP_BUTTERFLY_CUTOFF("search.lqpButterflyCutoff", 8, 0.0, 1024.0),
    SEARCH_LQP_START_INDEX("search.lqpStartIndex", 8, 0.0, 128.0),
    SEARCH_LQP_MAX_DEPTH("search.lqpMaxDepth", 3, 0.0, 16.0),
