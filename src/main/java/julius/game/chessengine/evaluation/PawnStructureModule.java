...
public final class PawnStructureModule implements EvaluationModule, MaterialModule.PawnChangeListener {
    ...
    public static final int PASSED_PAWN_BONUS = 70;
    public static final int CONNECTED_PAWN_BONUS = 10;
    public static final int PAWN_ISLAND_PENALTY = -7;
    public static final int DOUBLED_PAWN_PENALTY = -16;
    public static final int ISOLATED_PAWN_PENALTY = -12;
    public static final int ADVANCED_PAWN_BONUS = 10;
    public static final int BLOCKED_PAWN_PENALTY = -12;
    public static final int BACKWARD_PAWN_PENALTY = -14;
    public static final int OWN_KING_BLOCKS_PASSED_PAWN_PENALTY = -160;
    public static final int PASSED_PAWN_FREE_PATH_BONUS_PER_RANK = 14;
