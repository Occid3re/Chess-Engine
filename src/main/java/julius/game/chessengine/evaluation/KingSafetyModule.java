...
public final class KingSafetyModule implements EvaluationModule {
    ...
    private static final int BACKRANK_WEAKNESS_ENDGAME_PENALTY = -70;
    ...
    static {
        ATTACK_WEIGHTS[PAWN] = 8;
        ATTACK_WEIGHTS[KNIGHT] = 16;
        ATTACK_WEIGHTS[BISHOP] = 16;
        ATTACK_WEIGHTS[ROOK] = 24;
        ATTACK_WEIGHTS[QUEEN] = 32;
    }
