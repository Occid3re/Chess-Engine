...
public final class BatteryModule implements EvaluationModule {
    ...
    static {
        BATTERY_ATTACK_MIDGAME[PAWN] = 8;
        BATTERY_ATTACK_ENDGAME[PAWN] = 6;

        BATTERY_ATTACK_MIDGAME[KNIGHT] = 10;
        BATTERY_ATTACK_ENDGAME[KNIGHT] = 8;

        BATTERY_ATTACK_MIDGAME[BISHOP] = 11;
        BATTERY_ATTACK_ENDGAME[BISHOP] = 9;

        BATTERY_ATTACK_MIDGAME[ROOK] = 16;
        BATTERY_ATTACK_ENDGAME[ROOK] = 13;

        BATTERY_ATTACK_MIDGAME[QUEEN] = 22;
        BATTERY_ATTACK_ENDGAME[QUEEN] = 18;

        BATTERY_ATTACK_MIDGAME[KING] = 32;
