...
public class Engine {
     ...
     * recycled. 512 comfortably exceeds the engine's maximum expected search depth (~256 plies)
     * while still keeping memory usage bounded.
     */
    private static final int ACTIVE_SNAPSHOT_HISTORY = 512;
